              ...
              <tbody>
                {filteredPods.map((pod, index) => (
                  <tr
                    ...
                    className={`border-b border-border hover:bg-muted/50 transition-colors cursor-pointer ${index % 2 === 0 ? 'bg-background' : 'bg-muted/20'
                      }`}
                  >
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-1">
                        ...
                        <span className={`text-sm font-medium ${pod.restartCount > 5 ? 'text-red-500' :
