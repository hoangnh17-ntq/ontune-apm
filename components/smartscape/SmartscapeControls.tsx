...
export const SmartscapeTimeline = () => {
    return (
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 w-[600px] bg-card/90 backdrop-blur border border-border rounded-full px-4 py-2 flex items-center gap-4 shadow-2xl z-50">
            <button className="p-2 hover:bg-muted rounded-full text-blue-500 transition-colors">
        ...
        <div className="absolute top-20 left-4 z-40 flex flex-col gap-3">
            ...
            <div className="relative">
                ...
                <input
                    ...
                    className="bg-card/90 backdrop-blur border border-border rounded-full pl-9 pr-4 py-1.5 text-xs text-foreground focus:outline-none focus:border-primary w-[240px]"
                />
            </div>
                    ...
                    return (
                        <div
                            ...
                            className={cn(
                                ...
                                isActive
                                    ? `bg-${f.color}-500/20 border-${f.color}-500 text-${f.color}-500`
